...
const random = {
  uniformDiscrete: (min, max) => Math.floor(Math.random() * (max - min + 1)) + min,
};
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            In your smile, I see everything beautiful in this world. Every moment
            with you is a treasure I hold dear to my heart.
          </p>
